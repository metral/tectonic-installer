...
| tectonic_azure_external_master_subnet_id | Subnet name within an existing VNet to deploy master nodes into. Required to use an existing VNet. Example: `"subnet-111111"` | string | `` |
...
| tectonic_azure_external_worker_subnet_id | Subnet name within an existing VNet to deploy master nodes into. Required to use an existing VNet. Example: `"subnet-111111"` | string | `` |
